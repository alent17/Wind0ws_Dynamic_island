...
<main>
  ...
  <div class="workspace">
    ...
    <aside>
      ...
      <section class="media-scene-section"><h2>{t("mediaScene")}</h2><div class="scenario-grid">
...
<style>
  ...
  .segmented button,.endpoints button{border:0;background:transparent;color:#66666e;font-size:11px;cursor:pointer;transition:color 140ms ease,background 140ms ease,transform 120ms ease}.segmented button:hover,.endpoints button:hover{color:#111113}
  ...
  @media(prefers-reduced-motion:reduce){.skeleton-row i{animation:none}.setting-choice,.segmented button,.edge-grid button,.scenario-grid button,.tool-list button,.ordered-row,.icon-button,.ordered-row button,.search-row button,.apply-button,.reset-button{transition:none}}
